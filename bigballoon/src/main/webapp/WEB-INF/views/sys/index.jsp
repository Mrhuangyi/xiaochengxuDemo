...
<head>
	...
	<link rel="stylesheet" href="${path}/res/layui/css/layui.css" media="all" >
  	...
  	<link rel="stylesheet" href="${path}/res/css/mycss/layout.css" media="all" />
	...
	<div class="layui-layout layui-layout-admin beg-layout-container">
		<div class="layui-header beg-layout-header">
			<div class="beg-layout-main beg-layout-logo">
				<a href="" target="_blank" class="one-logo">氢生活</a>
			</div>
				...
				<ul class="layui-nav beg-layout-nav" lay-filter="user">
					...
					<li class="layui-nav-item">
						<a href="javascript:;" class="beg-layou-head">
							<img src="${path }${admin.img }" class="layui-nav-img">
							<span>${admin.loginName }</span>
						</a>
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" data-tab="true" data-url='${path}/admin/personInfo.do'>
									<i class="fa fa-user-circle" aria-hidden="true"></i>
									<cite>个人信息</cite>
								</a>
							</dd>
							<dd>
								<a href="javascript:;" data-tab="true" data-url="${path }/admin/pwd.do">
		...
		<div class="layui-side beg-layout-side" >
			 <div class="layui-side-scroll">
			    	...
			    	<div class="user-info">
			            <div class="photo">
			                <img src="${path }${admin.img }" alt="">
			            </div>
			            <p>${admin.loginName },您好!</p>
			        </div>
