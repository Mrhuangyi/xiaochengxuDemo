...
//	}
	...
	public void digui(List<Menu> list){
		for(Menu m : list){
...
//	public void diguiTreeCheck(List<MenuTreeCheck> list){
//		for(MenuTreeCheck m : list){
//			List<MenuTreeCheck> listTemp = menuMapper.getByPidTreeCheck(String.valueOf(m.getId()));
//			if(listTemp.size() > 0){
//				m.setChildren(listTemp);
...
//		List<MenuTreeCheck> list = menuMapper.getByPidTreeCheck(String.valueOf(menu.getId()));
//		diguiTreeCheck(list);
//		return list;
//	}
